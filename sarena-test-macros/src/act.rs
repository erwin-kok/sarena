...
impl ActProgram {
    ...
    pub(crate) fn expand(&self) -> TokenStream {
        match self.mode {
            ProgramMode::Tc => passthrough_tc("act", &self.name, &self.item),
            ProgramMode::Xdp => passthrough_xdp("act", &self.name, &self.item),
        }
    }
}
...
mod tests {
    ...
    fn test_tc_expand() {
        ...
        let expected = quote! {
            ...
            fn __test_fw_act_my_test(ctx: *mut ::aya_ebpf::bindings::__sk_buff) -> i32 {
    ...
    fn test_xdp_expand_with_order() {
        ...
        let expected = quote! {
            ...
            fn __test_fw_act_firewall_test(ctx: *mut ::aya_ebpf::bindings::xdp_md) -> u32 {
